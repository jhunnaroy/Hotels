...
router.post('/', async (req, res) =>{
    try{
        ...
        //method for insert single data in our database.
        // const newMenu = new MenuItem(data);
        // const response = await newMenu.save();

        //method for insert single data in our db.
        // const response = await MenuItem.insertOne(data)

        //method for insert array of data in our database that takes always array as data.
        // const response = await MenuItem.insertMany(data);

        //method for insert array of data in our database that takes array or object both.
